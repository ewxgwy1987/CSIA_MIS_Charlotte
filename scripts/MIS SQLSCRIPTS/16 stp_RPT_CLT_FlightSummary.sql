...
CREATE PROCEDURE dbo.stp_RPT_CLT_FlightSummary
		  @DTFROM datetime , 
		  @DTTO datetime
		  --@AIRLINE varchar(max) , 
...
--DECLARE @DTFROM DATETIME='2014-4-6';
--DECLARE @DTTO DATETIME='2014-4-7';
--EXEC stp_RPT_CLT_FlightSummary @DTFROM,@DTTO;
