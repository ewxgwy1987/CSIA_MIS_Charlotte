...
ALTER PROCEDURE dbo.stp_RPT_CLT_SortCorrelation
		  @SDO datetime , 
		  @AIRLINE varchar(max)
AS
BEGIN
	...
	UPDATE SC
	SET SC.FIRST_MU=AIR.FIRST_CLASS, SC.BUSINESS_MU=AIR.BUSINESS_CLASS
	FROM #SC_SortCorrelation_TEMP SC, AIRLINES AIR
	WHERE SC.AIRLINE=AIR.CODE_IATA;--FIRST & BUSINESS
...
--DECLARE @AIRLINE VARCHAR(MAX)='9E';
--DECLARE @SDO DATETIME='2014/4/5';
--EXEC stp_RPT_CLT_SortCorrelation @SDO,@AIRLINE;