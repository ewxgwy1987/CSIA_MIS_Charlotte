...
ALTER PROCEDURE dbo.stp_RPT17_IndvFlightSummary_GWYTEST
		  @DTFROM datetime , 
		  @DTTO datetime,
		  @AIRLINE varchar(max) , 
...
BEGIN
	...
	FROM ITEM_ENCODING_REQUEST IER,#IFS_BAGSDETAIL_TEMP FBD WITH(NOLOCK)
	...
	CREATE INDEX #IFS_TAGREAD_TEMP_IDXLP1 ON #IFS_TAGREAD_TEMP(LICENSE_PLATE1);
