...
ALTER PROCEDURE dbo.stp_RPT_CLT_INDIVIDUAL_EDS
		  @DTFROM DATETIME,
		  @DTTO DATETIME,
...
BEGIN
	...
	--1. ESTOP 
	UPDATE	#INDIV_EDS_STATUS
	SET		ESTOP = dbo.RPT_GET_FAULT_DURATION(@DTFROM,@DTTO,@SUBSYSTEM,@ESTP_EQUIPID,'AA_ESTP')
	...
	--5. JAMS
	UPDATE	#INDIV_EDS_STATUS
	SET		JAMS = dbo.RPT_GET_FAULT_TIMES(@DTFROM,@DTTO,@SUBSYSTEM,@EQUIP_ID,'AA_BJAM')
	...
	WHERE ITI.TIME_STAMP BETWEEN @DTFrom AND @DTTo
		...
		AND LOC.SUBSYSTEM=ELD.SUBSYSTEM AND ELD.SUBSYSTEM=@SUBSYSTEM
